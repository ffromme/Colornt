...
class Kuis1ResultPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<Kuis1Provider>(context);
    final accuracy = provider.accuracy;
    final correctAnswers = provider.correctAnswer;
    ...
    String getSubMessage() {
      if (accuracy >= 80) return 'Kamu sangat mahir mengenali warna!';
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.popUntil(context, ModalRoute.withName('Kuis1Instruksi'));
                    },
