...
class Kuis2ResultPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final provider = Provider.of<Kuis2Provider>(context);
    final accuracy = provider.accuracy;
    final score = provider.score;
    final totalSlots = provider.totalSlotsToFill;
    ...
    String getSubMessage() {
      if (accuracy >= 80) return 'Kamu sangat mahir menyusun gradasi warna!';
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.popUntil(context, ModalRoute.withName('Kuis2Instruksi'));
                    },
